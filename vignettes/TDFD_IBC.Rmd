...
| <span> |
| :------------------------------------------------------------------------------------------------------------ |
| **WARNING:** Please go to the Figure 2 section to see how group-specific taxa (i.e., taxa.Si.G1, taxa.Si.G3, taxa.Si.common) were estimated |
| <span> |
```{r, eval = FALSE}
...
pathSHP <- "C:/Users/benjamin/Documents/TDFD_IBCmetals/data/QGIS_shp_france"
...
# Functional contribution and functional originality for dominant species common to UnCont1 and Cont and for dominant species specific
...
tiff(paste0(pathFig, "/Rplot_trait_x_IBC_Fig3.tiff"),
     units = "in", width = 10, height = 8, res = 300)
print(Fig3)
dev.off()
```
![Figure 3](C:/Users/benjamin/Documents/Travail_BA/IRSTEA_AFB48/Traits_x_IBC/TDFD_IBCmetals/figures/Rplot_trait_x_IBC_Fig3.png)
